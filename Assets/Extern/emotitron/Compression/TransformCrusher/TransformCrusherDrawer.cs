...
namespace emotitron.Compression
{
	...
	public class TransformCrusherDrawer : CrusherDrawer
	{
		...
		public override void OnGUI(Rect r, SerializedProperty property, GUIContent label)
		{
			...
			MonoBehaviour targetAsMonoB = (property.serializedObject.targetObject as MonoBehaviour);
			if (target.defaultTransform == null && targetAsMonoB != null)
			{
				target.defaultTransform = targetAsMonoB.transform;
			}
